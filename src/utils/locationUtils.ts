    ...
    <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b-2 border-slate-200 text-charcoal shadow-[0_2px_0_0_#f1f5f9]">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-1">
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-3 shrink-0">
          <div className="flex items-center space-x-1.5 sm:space-x-2.5 cursor-pointer group" onClick={onNavigateToLanding}>
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-[10px] sm:rounded-[12px] overflow-hidden border-2 border-slate-200 bg-white p-0.5 shadow-[0_2px_0_0_#cbd5e1] group-hover:border-eager-green transition-all shrink-0">
              <img
                src={logoImg}
            ...
            <div className="text-left hidden xs:block">
              <h1 className="font-display font-black text-xs sm:text-lg leading-none tracking-tight text-slate-900 flex items-center">
          ...
          <div className="hidden sm:flex items-center pl-2 sm:pl-3 border-l-2 border-slate-200">
            {isOnline ? (
              <span className="inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded-[10px] text-[9px] sm:text-[10px] font-bold bg-brand-50 text-eager-green border-2 border-brand-100 shadow-[0_2px_0_0_#d7ffb8]">
              ...
              <span className="inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded-[10px] text-[9px] sm:text-[10px] font-bold bg-rose-50 text-rose-600 border-2 border-rose-200 shadow-[0_2px_0_0_#fecdd3] animate-bounce">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 shrink-0">
          {/* Quick Role Switcher */}
          <div className="bg-slate-100 p-1 rounded-[12px] sm:rounded-[16px] flex items-center space-x-0.5 sm:space-x-1 border-2 border-slate-200">
            <button
              onClick={() => setCurrentRole("Customer")}
              className={`flex items-center space-x-1 px-1.5 sm:px-3 py-1 sm:py-1.5 rounded-[8px] sm:rounded-[12px] text-[11px] sm:text-xs font-bold transition-all duration-150 ${
            ...
            >
              ...
              <span className="hidden md:inline">Mechanic</span>
            </button>
          </div>
          ...
          {currentRole === "Customer" && (
            <motion.button
              ...
              className="duo-btn-green-sm text-[11px] sm:text-xs py-2 px-2.5 sm:px-4 rounded-[10px] sm:rounded-[14px] whitespace-nowrap font-black uppercase tracking-wider shrink-0"
          ...
          <button
            ...
            className="p-1.5 sm:p-2 text-slate-500 hover:text-spark-blue hover:bg-sky-50 rounded-[10px] sm:rounded-[12px] transition-all relative border-2 border-slate-200 bg-white shadow-[0_2px_0_0_#cbd5e1] active:translate-y-[1px] active:shadow-none shrink-0"
            title="View Live Notification Logs"
          >
            <MessageSquare className="h-4 w-4 sm:h-4.5 sm:w-4.5 text-slate-600" />
            <span className="absolute top-0.5 right-0.5 w-2 h-2 sm:w-2.5 sm:h-2.5 bg-eager-green rounded-full border-2 border-white animate-pulse" />
          </button>

          {/* Notifications Log */}
          <div className="relative shrink-0">
            <button className="p-1.5 sm:p-2 text-slate-500 hover:text-spark-blue hover:bg-sky-50 rounded-[10px] sm:rounded-[12px] transition-all relative border-2 border-slate-200 bg-white shadow-[0_2px_0_0_#cbd5e1] active:translate-y-[1px] active:shadow-none">
              <Bell className="h-4 w-4 sm:h-4.5 sm:w-4.5 text-slate-600" />
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-rose-500 text-white text-[8px] sm:text-[9px] font-mono font-bold w-4 h-4 sm:w-5 sm:h-5 rounded-full flex items-center justify-center border-2 border-white">
                  {unreadCount}
                </span>
              )}
            </button>
